...
import { CheckCircle2, AlertCircle, X, File } from "lucide-react";
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between mb-2 max-w-full">
                <p className="text-sm font-medium truncate whitespace-nowrap overflow-hidden text-ellipsis">{file.name}</p>
